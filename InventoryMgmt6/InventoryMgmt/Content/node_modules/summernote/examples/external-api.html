    ...
    <div class="container">
      ...
      <div class="custom-toolbar">
        <div class="btn-group" role="group" aria-label="...">
          <button type="button" class="btn btn-primary"  data-container="body" data-trigger="hover" data-placement="left" data-content="Sample Content" title="Sample Button" onclick="command('justifyLeft')">Left </button>
          <button type="button" class="btn btn-primary"  onclick="command('justifyCenter')">Middle</button>
          <button type="button" class="btn btn-primary"  onclick="command('justifyRight')">Right</button>
        </div>
