...
namespace InventoryMgmt.Controllers
{
    public class ReportController : Controller
    {
        ...
        //{
        //    using (ReportEntities dc = new ReportEntities())
        //    {
        //        var v = dc.Orders.ToList();
        //        return View(v);
        //    }
        //}
        public ActionResult Report(string id)
        {
            ...
            List<Report> cm = new List<Report>();
            using (ReportEntities dc = new ReportEntities())
            {
                //cm = dc.Orders.ToList();
                var v = dc.Orders.ToList();
        ...
        public ActionResult Create([Bind(Include = "Id,Customer,InventoryId,TotalAmount,TotalPrice")] Order order)
        {
